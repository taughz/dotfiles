...
export DEV_USER_UID=$FIXED_DEV_USER_UID
export DEV_USER_GID=${FIXED_DEV_USER_GID:-$FIXED_DEV_USER_UID}
export DEV_USER_FULLNAME=${FIXED_DEV_USER_FULLNAME:-$FIXED_DEV_USER}
export DEV_USER_HOME=${FIXED_DEV_USER_HOME:-"/home/$FIXED_DEV_USER"}
export DEV_USER_SHELL=${FIXED_DEV_USER_SHELL:-"/bin/bash"}
